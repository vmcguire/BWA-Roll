...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-Roll/`**
...
```bash
git subtree push --prefix=BWA-Roll git@github.com:vmcguire/BWA-Roll.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-Roll.vst3`.
