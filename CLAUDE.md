# BWA-Roll — read before doing anything

> ✅ **This is the CANONICAL home for BWA-Roll.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-Roll/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-Roll; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-Roll**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-Roll`) and attach the notarized `BWA-Roll.vst3`.
